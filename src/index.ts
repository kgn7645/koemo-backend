...
import { configureDNS } from './utils/dnsConfig';
configureDNS();
        ...
        try {
          ...
          switch (message.type) {
            ...
            case 'accept-match':
              ...
              await matchingService.acceptMatch(userId, acceptCallId);
              break;
            ...
            case 'reject-match':
              ...
              await matchingService.cancelMatch(userId, rejectCallId);
              break;
            ...
            case 'end-match':
              ...
              await matchingService.cancelMatch(userId, endCallId);
              break;
              
            case 'get-status':
              const status = matchingService.getQueueSize();
